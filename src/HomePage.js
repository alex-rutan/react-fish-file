...
/** Homepage: either returns a welcome card or if logged in, 
 *  your favorite locations and all of your records
 * 
 *  Context: currentUser
 */
      ...
      <div className="HomePage home-page-2 text-center">
        <div className="card home-page-card">
          ...
          <div className="card-body">
            <p>Log in or sign up above to build your own flow and
              weather monitoring interface and fishing history.</p>
          </div>
        </div>
      </div>
  )
