...
function AddLocationForm() {
  ...
  // Handles form changes on each keystroke
        ...
        <form className="location-form" onSubmit={handleSubmit}>
          ...
          <div className="form-floating mb-4">
            ...
            <div id="passwordHelpBlock" className="form-text m-2">
              Provide a USGS Station Number if you'd like to access current and
              historical flow data for your location. Visit
              https://waterdata.usgs.gov/STATE_ABBR_HERE/nwis/current/?type=flow
              with the state abbreviation included to view river flow gauge
              sites and find the appropriate USGS Station Number.
            </div>
          ...
          <div className="form-floating mb-4">
            ...
            <div id="fishHelpBlock" className="form-text m-2">
              Provide a list of fish species for the location. You must separate
              fish species with a comma and space like so:
